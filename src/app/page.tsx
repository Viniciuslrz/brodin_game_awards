      ...
      <div className="w-5/6 h-5/6 rounded-md grid bg-slate-300 text-black">
        ...
        {pageCounter==0&&
          <div className="flex space-x-2 mx-auto my-2">
           <CustomButton label="Começar" onClick={handleNextPage}/>
          </div>
        }
        ...
        {pageCounter>0&&
          <div className="flex space-x-2 mx-auto my-2">
            {pageCounter<4&&<CustomButton label="Voltar" onClick={handlePrevPage}/>}
            {pageCounter<4&&<CustomButton label="Avançar" onClick={handleNextPage}/>}
            {pageCounter==4&&<CustomButton label="Resultados" onClick={handleNextPage}/>}
          </div>
        }
      </div>
    </div>
